...
window.plugNmeetConfig = {
  ...
  // Available options: 'original' | 'h360fps3' | 'h720fps5' | 'h720fps15' | 'h1080fps15' | 'h1080fps30'.
  // Default: 'original' (preserves the shared screen's native resolution).
  defaultScreenShareResolution: 'original',
